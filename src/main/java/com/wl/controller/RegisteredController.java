...
/**
 * Created by Vincent on 2018-08-10.
 */
@Controller
public class RegisteredController {
    ...
    @RequestMapping(value = "registeredMess")
    public Object registeredMess(HttpServletRequest request, HttpServletResponse response,Model model)throws IOException {
        ...
        String introduction = request.getParameter("form-about-yourself");
        logger.info("姓参数: {},名参数：{},邮箱：{}",firstName,lastName,email);
        Map<String, Object> result = userService.registeredData(firstName,lastName,email,password,introduction);
