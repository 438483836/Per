...
public class VerificationUtil {
    ...
    public static String upperPieceV(DeskInformation deskInformation){
        ...
        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append(TypeConversion.getHexStringI(Integer.parseInt(deskInformation.getDataPacket()),2));//数据包
        stringBuffer.append("1E");//数据总长度
        stringBuffer.append(TypeConversion.getHexStringI(Integer.parseInt(deskInformation.getPcNum()),2));//上位机编号
        ...
        stringBuffer.append(TypeConversion.getHexStringI(Integer.parseInt(deskInformation.getImportantMess()),6));//重要信息
